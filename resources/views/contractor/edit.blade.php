        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" action="contractor/{{ $contractor->id }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="name" id="name" placeholder="Name" type="text"
                                        class="form-control" value="{{ $contractor->name }}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="address" id="address" placeholder="Address" type="text"
                                        class="form-control" value="{{ $contractor->address }}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="phone" id="phone" placeholder="Phone" type="text"
                                        class="form-control" value="{{ $contractor->phone }}">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="email" id="email" placeholder="Email" type="text"
                                        class="form-control" value="{{ $contractor->email }}">
                                </div>
                            </div>
