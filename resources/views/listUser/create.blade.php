        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        Thêm người uỷ quyền hoặc được uỷ quyền
                    ...
                    <div class="card-body">
                        <form method="post" action="user" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="cmnd" id="cmnd" placeholder="Số CMND hoặc hộ chiếu" type="text"
                                        class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="title" id="title" placeholder="Chức danh" type="text"
                                        class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select class="form-control" name="type_user" id="type_user">
                                        ...
                                        <option value="2">Người được uỷ quyền</option>
                                    </select>
