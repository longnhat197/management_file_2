                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    <li>
                                        <a href="./home" class="{{ request()->segment(01) == 'home' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Trang chủ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./file" class="{{ request()->segment(01) == 'file' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý file
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./contractor" class="{{ request()->segment(01) == 'contractor' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách nhà thầu
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./project" class="{{ request()->segment(01) == 'project' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách dự án
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./customer" class="{{ request()->segment(01) == 'customer' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách khách hàng
                                        </a>
                                    </li>

                                    <li>
                                        <a href="./package" class="{{ request()->segment(01) == 'package' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách gói thầu
                                        </a>
                                    </li>

                                    <li>
                                        <a href="./user" class="{{ request()->segment(01) == 'user' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Người ĐD và ĐUQ
                                        </a>
                                    </li>

                                    <li>
                                        <a href="./template" class="{{ request()->segment(01) == 'template' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Các mẫu hồ sơ
                                        </a>
                                    </li>
                                </ul>
                            </li>
