                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        == 0 || Auth::user()->level == 2 ? 'disabled' : '' }} id="name_moi_thau_test" value="{{
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="so_tien_giam_gia_test">Số tiền giảm giá (ghi giá trị bằng số, bằng
                                            chữ và đồng
                                            tiền dự thầu):</label>
                                        <textarea name="so_tien_giam_gia" {{ $detail->enabled == '0' || Auth::user()->level == 2 ? 'disabled' : '' }} class="form-control" id="so_tien_giam_gia_test" cols="30"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="gia_tri_giam_gia_test">Giá trị giảm giá (ghi giá trị bằng số, bằng
                                            chữ và đồng
                                            tiền dự thầu):</label>
                                        <textarea name="gia_tri_giam_gia" {{ $detail->enabled == '0' || Auth::user()->level == 2 ? 'disabled' : '' }} class="form-control" id="gia_tri_giam_gia_test" cols="30"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group date-container col-md-4">
                                        ...
                                        <input class="form-control" {{ $detail->enabled == '0' || Auth::user()->level == 2 ? 'disabled' : '' }}
