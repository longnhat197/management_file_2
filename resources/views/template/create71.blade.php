    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form action="./template/71" id="myForm" method="post">
                        @csrf
                        <nav>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <textarea name="table_content"
                                            ...
                                            <table class="MsoNormalTable" style="width: 600px; border-collapse: collapse; border: none;" border="1" width="0" cellspacing="0" cellpadding="0">
                                                <tbody>
        ...
        <div class="col-md-12">
            <div>
                ...
                <p class="MsoNormal" style="text-align: right; margin: 6.0pt 2.15pt .0001pt 0in;" align="right"><span
                        ...
                        <span
                            style="background: yellow; mso-highlight: yellow;" id="date1">______________________</span><br>T&ecirc;n
                        th&agrave;nh vi&ecirc;n của nh&agrave; thầu li&ecirc;n danh: <span
                            style="background: yellow; mso-highlight: yellow;" id="name_thanh_vien_lien_danh1">________________________</span></span>
                </p>
...
@endsection
@section('script')
<script type="text/javascript" src="./dashboard/assets/scripts/create71.js"></script>
<script>
