    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form action="./template/9" method="post">
                        @csrf
                        <nav>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <textarea name="table_content"
                                            ...
                                            <table style="border-collapse: collapse; width: 600px; height: 335.859px;" border="1">
                                                <tbody>
                                                ...
                                                <td style="width: 75%; height: 44.7812px; padding:5px auto;border-color: rgb(0, 0, 0); border-style: solid; border-width: 1px;" colspan="3"><span style="font-family: 'times new roman', times, serif;"><strong><span style="font-size: 12pt;">Năm t&agrave;i ch&iacute;nh của nh&agrave; thầu từ ng&agrave;y___ th&aacute;ng___ đến ng&agrave;y___ th&aacute;ng ____ (nh&agrave; thầu điền nội dung n&agrave;y)</span></strong></span></td>
                                                </tr>
        ...
        <div class="col-md-12">
            <div>
                ...
                <p class="MsoNormal" style="text-align: right; margin: 6.0pt 2.15pt .0001pt 0in;" align="right"><span
                        ...
                        thầu: <span
                            style="background: yellow; mso-highlight: yellow;" id="name_nha_thau1">________________</span>
                            <br>Ng&agrave;y:
...
@endsection
@section('script')
<script type="text/javascript" src="./dashboard/assets/scripts/create9.js"></script>
<script>
