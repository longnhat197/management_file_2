    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form action="./template/6" id="myForm" method="post">
                        @csrf
                        <nav>
            ...
            <div>
                ...
                <p style="text-align: right;"><span
                        ...
                        <span style="background: yellow; mso-highlight: yellow;"
                            id="date1">_____________________</span></span>
                </p>
...
@endsection
@section('script')
<script type="text/javascript" src="./dashboard/assets/scripts/create6.js"></script>
<script>
