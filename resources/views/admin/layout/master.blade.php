                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="{{ request()->segment(1) == 'template' ? 'mm-active' : '' }}">
                                ...
                                {{-- <ul>
                                    <li>
                                        <a href="./home"
                                            class="{{ request()->segment(01) == 'home' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Trang chủ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./file"
                                            class="{{ request()->segment(01) == 'file' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý file
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./contractor"
                                            class="{{ request()->segment(01) == 'contractor' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách nhà thầu
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./project"
                                            class="{{ request()->segment(01) == 'project' ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i>Quản lý danh sách dự án
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./customer"
                                            class="{{ request()->segment(01) == 'customer' ? 'mm-active' : ''}}">
                                    ...
                                    <li>
                                        <a href="./package"
                                            class="{{ request()->segment(01) == 'package' ? 'mm-active' : ''}}">
                                    ...
                                    <li>
                                        <a href="./user"
                                            class="{{ request()->segment(01) == 'user' ? 'mm-active' : ''}}">
                                    ...
                                    <li>
                                        <a href="./template"
                                            class="{{ request()->segment(01) == 'template' ? 'mm-active' : ''}}">
