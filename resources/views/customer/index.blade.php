    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="./customer/create" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                            ...
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">
                                                    <a style="color: #495057"
                                                        href="./customer/{{ $customer->id }}/edit">{{ $customer->name
                                                        }}</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <td class="text-center">
                                    <a href="./customer/{{ $customer->id }}/edit" data-toggle="tooltip" title="Edit"
