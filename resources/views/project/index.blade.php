    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="./project/create" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                            ...
                            <tr>
                                            ...
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">
                                                    <a style="color: #495057"
                                                        href="./project/{{ $project->id }}/edit">{{ $project->name
                                                        }}</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">{{ $project->updated_at }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <a href="./project/{{ $project->id }}/edit" data-toggle="tooltip" title="Edit"
                                        data-placement="bottom" class="btn btn-outline-warning border-0 btn-sm">
                                        <span class="btn-icon-wrapper opacity-8">
                                            <i class="fa fa-edit fa-w-20"></i>
                                        </span>
                                    </a>
                                    <form class="d-inline" action="./project/{{ $project->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
