$(document).ready(function () {
    ...
    nam = document.getElementById('nam_test')
    detail_id = document.getElementById('detail_id')
    var current = 0
    nam.onkeyup = function () {
        if (current == 0) {
            document.getElementById("nam1").innerText = this.value
            document.getElementById("nam2").innerText = '__ [ghi năm]'
        } else {
            document.getElementById("nam2").innerText = this.value
            document.getElementById("nam1").innerText = '__ [ghi năm]'
        }
    ...
    if (check != '') {
        ...
        if (check == 0) {
            document.getElementById('check1').innerHTML = '&#x2611;'
            document.getElementById('check2').innerHTML = '&#x2610;'
            document.getElementById("nam1").innerText = nam.value != '' ? nam.value : '__ [ghi năm]'

        } else {
            document.getElementById('check1').innerHTML = '&#x2610;'
            document.getElementById('check2').innerHTML = '&#x2611;'
            document.getElementById("nam2").innerText = nam.value != '' ? nam.value : '__ [ghi năm]'
        }
    }
    ...
    nameThanhVienLienDanh.onkeyup = function () {
        document.getElementById('name_thanh_vien_lien_danh1').innerText = this.value
        if (this.value == '') {
            document.getElementById('name_thanh_vien_lien_danh1').innerText = '________________'
        }
    }
